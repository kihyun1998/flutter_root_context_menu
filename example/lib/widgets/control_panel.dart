    ...
    return Column(
      ...
      children: [
        ...
        _buildLabeledSlider(
          ...
          1000,
          20,
          '${settings.openDelay.toInt()}ms',
          (v) => _update(() => settings.openDelay = v),
        ),
        _buildLabeledSlider(
          'Close Delay',
          settings.closeDelay,
          ...
          1000,
          20,
          '${settings.closeDelay.toInt()}ms',
          (v) => _update(() => settings.closeDelay = v),
        ),
        _buildLabeledSlider(
          'Horizontal Offset',
          ...
          20,
          40,
          '${settings.horizontalOffset.toInt()}px',
          (v) => _update(() => settings.horizontalOffset = v),
        ),
        _buildLabeledSlider(
          'Max Depth',
          settings.maxDepth.toDouble(),
          1,
          10,
          9,
          '${settings.maxDepth}',
          (v) => _update(() => settings.maxDepth = v.toInt()),
        ),
        const SizedBox(height: 20),
      ],
    );
